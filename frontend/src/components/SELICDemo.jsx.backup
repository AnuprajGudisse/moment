/**
 * SELIC Integration Demo & Test Component
 * Demonstrates the SELIC-inspired features in action
 */
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-[var(--muted)]">
          Semantic-Enhanced Learned Image Compression in Action
        </p>
      ...
      {results && (
        <div className="space-y-6">
          ...
          {/* Compression Results */}
          <div className="bg-[var(--card-bg)] rounded-lg p-6 border border-[var(--border)]">
            <h3 className="text-xl font-bold mb-4">📊 Compression Optimization</h3>
            ...
            <div className="mb-6 p-4 bg-[var(--hover)] rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium">{results.qualityInfo?.used ? Math.round(results.qualityInfo.used * 100) : 'N/A'}%</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-4">
              <div>
                <h5 className="font-medium mb-2">Compression Settings</h5>
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span>Quality:</span>
                    <span>{(results.compressionSettings.quality * 100).toFixed(0)}%</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Format:</span>
                    <span>{results.compressionSettings.format}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Ratio:</span>
              ...
              <div>
                ...
                {results.enhancedMetadata?.suggestions ? (
                  ...
                  <div className="text-sm text-[var(--muted)]">
                    Enhanced suggestions available with backend processing
                  </div>
                )}
              </div>
            </div>
      ...
      {/* Info Panel */}
      <div className="bg-[var(--hover)] rounded-lg p-6 border border-[var(--border)]">
        <h3 className="text-lg font-bold mb-3">ℹ️ How SELIC Works</h3>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div>
            <h4 className="font-medium mb-2">🧠 Semantic Analysis</h4>
            <ul className="space-y-1 text-[var(--muted)]">
              <li>• AI describes image content</li>
              <li>• Extracts visual complexity</li>
              <li>• Identifies important regions</li>
              <li>• Analyzes color distribution</li>
            </ul>
          </div>
          <div>
            <h4 className="font-medium mb-2">🗜 Smart Compression</h4>
            <ul className="space-y-1 text-[var(--muted)]">
              <li>• Adjusts quality based on content</li>
              <li>• Preserves important details</li>
              <li>• Optimizes bit allocation</li>
              <li>• Reduces file size intelligently</li>
            </ul>
          </div>
        </div>
      </div>
