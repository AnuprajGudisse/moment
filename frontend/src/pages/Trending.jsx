...
export default function Trending() {
  ...
  return (
    <div className="min-h-screen bg-[var(--app-bg)]">
      <SideNav active="trending" onNavigate={(p) => (window.location.href = p)} onLogout={() => {}} query={query} setQuery={setQuery} />
      ...
      <BottomNav active="trending" onNavigate={(p) => (window.location.href = p)} />
    </div>
  );
}
